...
//            return [["method":"post",   "uri":"/login", "handler": login],
//                    ["method":"get",    "uri":"/logout", "handler":logout],
//                    ["method":"post",   "uri":"/login/oauth", "handler":oauth.login],
//                    ["method":"post",   "uri":"/register", "handler":register],
//                    ["method":"post",   "uri":"/forgotpassword", "handler":forgotPassword],
//                    ["method":"post",   "uri":"/user/update", "handler":updateProfile],
//                    ["method":"post",   "uri":"/user/upload", "handler":uploadPicture],
//                    ["method":"post",   "uri":"/changepassword", "handler":changePassword],
//                    ["method":"post",   "uri":"/resendEmail", "handler":resendEmail]
