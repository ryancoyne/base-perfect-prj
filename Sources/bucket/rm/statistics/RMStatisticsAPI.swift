...
struct RMStatisticsAPI {
    ...
    static func getAdminStatistics(_ dic : [String:Any]) throws -> [String:Any] {
        ...
        var start = RMServiceClass.sharedInstance.getMidnight()
        var end = RMServiceClass.getNow()
        ...
        var daterange = RMServiceClass.sharedInstance.getYesterday()
        ...
        daterange = RMServiceClass.sharedInstance.getTwoDaysAgo()
        start = daterange["start"]!
        end = daterange["end"]!
        rows = try Account().sqlRows(sqlstatement, params: [String(describing: start), String(describing: end)])
        ...
        daterange = RMServiceClass.sharedInstance.getLastWeek()
        start = daterange["start"]!
        end = daterange["end"]!
        rows = try Account().sqlRows(sqlstatement, params: [String(describing: start), String(describing: end)])
