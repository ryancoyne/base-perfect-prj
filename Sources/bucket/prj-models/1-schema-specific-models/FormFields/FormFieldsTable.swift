...
final class FormFieldsTable {
    ...
    static let sharedInstance = FormFieldsTable()
    let tbl = FormFields()
    ...
    private func table(_ schemaIn:String? = "public")-> String {
        ...
        createsql.append("field_id int NOT NULL DEFAULT 0, ")
