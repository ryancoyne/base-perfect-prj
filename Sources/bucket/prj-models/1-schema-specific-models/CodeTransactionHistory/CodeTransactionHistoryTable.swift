...
final class CodeTransactionHistoryTable {
    ...
    func create() {
        ...
        for i in PRJCountries.list  {
            createCodeTransactionHistory((i.uppercased()))
        }
    }
...
//            let _ = try? tbl.sqlRows(sequencesql, params: [])
    ...
    private func table(_ schemaIn:String? = "public")-> String {
        ...
        createsql.append("refunded_reason text COLLATE pg_catalog.default, ")
        ...
        createsql.append("refunded int NOT NULL DEFAULT 0, ")
        createsql.append("refundedby text COLLATE pg_catalog.default, ")
