...
public class USBank: PostgresStORM {
    ...
    //MARK: Table name
    override public func table() -> String { return "usbank" }
    ...
    override open func to(_ this: StORMRow) {
        ...
        if let data = this.data.usBankDic.countryId {
           country_id  = data
        }
        
        if let data = this.data.usBankDic.retailerId {
            retailer_id = data
        }
        
        if let data = this.data.usBankDic.retailerContactId {
            retailer_contact_id = data
        }
        
        if let data = this.data.usBankDic.address1 {
            address1 = data
        }
        
        if let data = this.data.usBankDic.address2 {
            address2 = data
        }
        
        if let data = this.data.usBankDic.address3 {
            address3 = data
        }
        
        if let data = this.data.usBankDic.city {
            city = data
        }
        
        if let data = this.data.usBankDic.state {
            state = data
        }
        
        if let data = this.data.usBankDic.postalCode {
            postal_code = data
        }
        
        if let data = this.data.usBankDic.ach_transfer_minimum {
    ...
    func asDictionary() -> [String: Any] {
        ...
        if self.country_id.isNotNil {
            dictionary.usBankDic.countryId = self.country_id
        }
        
        if self.retailer_id.isNotNil {
            dictionary.usBankDic.retailerId = self.retailer_id
        }
        
        if self.retailer_contact_id.isNotNil {
            dictionary.usBankDic.retailerContactId = self.retailer_contact_id
        }
        
        if self.address3.isNotNil {
            dictionary.usBankDic.address3 = self.address3
        }
        
        if self.address2.isNotNil {
            dictionary.usBankDic.address2 = self.address2
        }
        
        if self.address1.isNotNil {
            dictionary.usBankDic.address1 = self.address1
        }
        
        if self.city.isNotNil {
            dictionary.usBankDic.city = self.city
        }
        
        if self.state.isNotNil {
            dictionary.usBankDic.state = self.state
        }
        
        if self.postal_code.isNotNil {
            dictionary.usBankDic.postalCode = self.postal_code
        }

        if self.ach_transfer_minimum.isNotNil {
            dictionary.usBankDic.ach_transfer_minimum = self.ach_transfer_minimum
        }
    ...
    func compare(targetItem: USBank)-> Bool {
