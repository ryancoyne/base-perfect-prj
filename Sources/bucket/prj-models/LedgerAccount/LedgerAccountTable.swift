...
final class LedgerAccountTable {
    ...
    static let sharedInstance = LedgerAccountTable()
    ...
    private func table()-> String {
        ...
        createsql.append("ledger_account_type_id int default 0, ")
