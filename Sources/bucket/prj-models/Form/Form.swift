...
public class Form: PostgresStORM {
    ...
    //MARK: Table name
    override public func table() -> String { return "form" }
    ...
    override open func to(_ this: StORMRow) {
        ...
        if let data = this.data.formDic.name {
            name = data
        }
        
        if let data = this.data.formDic.title {
            title = data
        }
    ...
    func asDictionary() -> [String: Any] {
        ...
        if self.title.isNotNil {
            dictionary.formDic.title = self.title
        }
    ...
    func compare(targetItem: Form)-> Bool {
