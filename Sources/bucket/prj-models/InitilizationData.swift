...
final class InitializeData {
    ...
    func addCountryCodes() {
        ...
        var insertstatement = "INSERT INTO \(tbl.name!)"
        ...
        insertstatement.append("('Korea (Democratic People's Republic of)','408','KP','PRK',\(create_time),'ADMIN_USER'),")
        ...
        insertstatement.append("('Lao People's Democratic Republic','418','LA','LAO',\(create_time),'ADMIN_USER'),")
