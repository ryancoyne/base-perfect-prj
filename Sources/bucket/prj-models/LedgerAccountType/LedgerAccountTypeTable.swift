...
final class LedgerAccountTypeTable {
    ...
    static let sharedInstance = LedgerAccountTypeTable()
    ...
    private func table()-> String {
        ...
        createsql.append("account_group text COLLATE pg_catalog.default, ")
        createsql.append("title text COLLATE pg_catalog.default, ")
