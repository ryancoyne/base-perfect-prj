...
final class LedgerTypeTable {
    ...
    static let sharedInstance = LedgerTypeTable()
    let tbl = LedgerType()
    ...
    private func table()-> String {
        ...
        createsql.append("account_type text COLLATE pg_catalog.default, ")
