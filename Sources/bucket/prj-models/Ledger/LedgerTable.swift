...
final class LedgerTable {
    ...
    static let sharedInstance = LedgerTable()
    let tbl = Ledger()
    ...
    private func table()-> String {
        ...
        createsql.append("ledger_account_id int default 0, ")
        createsql.append("ledger_type_id    int default 0, ")
        ...
        createsql.append("code_country_id int default 0, ")
