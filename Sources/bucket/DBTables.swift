...
//        viewsql.append("SELECT * FROM \(schema).\(tablename) WHERE redeemed = 0; ")
        ...
        viewsql.append("client_transaction_id text, terminal_id int, disputed int, disputedby text, customer_code text, redeemed int, retailer_user_id int, serial_number text) ")
        ...
        viewsql.append("            SELECT ct.id, ct.created, ct.amount, ct.total_amount, ct.client_location, ct.client_transaction_id, ct.terminal_id, ct.disputed, ct.disputedby, ct.customer_code, ct.redeemed, ct.refunded, tm.serial_number ")
        ...
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.customer_code, cth.redeemed, cth.refunded, tm.serial_number ")
