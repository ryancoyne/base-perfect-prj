...
//        viewsql.append("SELECT * FROM \(schema).\(tablename) WHERE redeemed = 0; ")
        ...
        viewsql.append("    IF (offsetBy = -1) AND (limitBy = -1) THEN ")
        
        // THIS IS THE OFFSETBY ELSIF:
        viewsql.append("    IF (retailerUserId = 0) AND (terminalId = 0) AND (eventId = 0) THEN ")
        
        viewsql.append("        RETURN QUERY ")
        viewsql.append("            SELECT ct.id, ct.created, ct.amount, ct.total_amount, ct.client_location, ct.client_transaction_id, ct.terminal_id, ct.disputed, ct.disputedby, ct.refunded, ct.refundedby, ct.customer_code, ct.redeemed, ct.retailer_user_id, ct.event_id, tm.serial_number ")
        ...
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.refunded, cth.refundedby, cth.customer_code, cth.redeemed, cth.retailer_user_id, cth.event_id, tm.serial_number ")
        ...
        viewsql.append("    ELSIF (retailerUserId = 0) AND (terminalId > 0) AND (eventId = 0) THEN ")
        ...
        viewsql.append("            FROM us.code_transaction_view_deleted_no AS ct ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = ct.terminal_id ")
        viewsql.append("            WHERE (ct.created BETWEEN fromDate AND toDate) AND (ct.retailer_id = retailerId)  AND (ct.terminal_id = terminalId) AND (ct.retailer_user_id = retailerUserId) AND (ct.event_id = eventId) ")
        viewsql.append("            UNION ")
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.refunded, cth.refundedby, cth.customer_code, cth.redeemed, cth.retailer_user_id, cth.event_id, tm.serial_number ")
        viewsql.append("            FROM us.code_transaction_history_view_deleted_no AS cth ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = cth.terminal_id ")
        viewsql.append("            WHERE (cth.created BETWEEN fromDate AND toDate) AND (cth.retailer_id = retailerId)  AND (cth.terminal_id = terminalId) AND (cth.retailer_user_id = retailerUserId) AND (cth.event_id = eventId) ")
        viewsql.append("            ORDER BY created DESC; ")
        ...
        viewsql.append("            FROM us.code_transaction_view_deleted_no AS ct ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = ct.terminal_id ")
        viewsql.append("            WHERE (ct.created BETWEEN fromDate AND toDate) AND (ct.retailer_id = retailerId) AND (ct.terminal_id = terminalId) AND (ct.event_id = eventId) ")
        viewsql.append("            UNION ")
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.refunded, cth.refundedby, cth.customer_code, cth.redeemed, cth.retailer_user_id, cth.event_id, tm.serial_number ")
        viewsql.append("            FROM us.code_transaction_history_view_deleted_no AS cth ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = cth.terminal_id ")
        viewsql.append("            WHERE (cth.created BETWEEN fromDate AND toDate) AND (cth.retailer_id = retailerId) AND (cth.terminal_id = terminalId) AND (cth.event_id = eventId) ")
        viewsql.append("            ORDER BY created DESC; ")
        ...
        viewsql.append("            FROM us.code_transaction_view_deleted_no AS ct ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = ct.terminal_id ")
        viewsql.append("            WHERE (ct.created BETWEEN fromDate AND toDate) AND (ct.retailer_id = retailerId) AND (ct.retailer_user_id = retailerUserId) AND (ct.event_id = eventId) ")
        viewsql.append("            UNION ")
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.refunded, cth.refundedby, cth.customer_code, cth.redeemed, cth.retailer_user_id, cth.event_id, tm.serial_number ")
        viewsql.append("            FROM us.code_transaction_history_view_deleted_no AS cth ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = cth.terminal_id ")
        viewsql.append("            WHERE (cth.created BETWEEN fromDate AND toDate) AND (cth.retailer_id = retailerId) AND (cth.retailer_user_id = retailerUserId) AND (cth.event_id = eventId) ")
        viewsql.append("            ORDER BY created DESC; ")
        ...
        viewsql.append("            FROM us.code_transaction_view_deleted_no AS ct ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = ct.terminal_id ")
        viewsql.append("            WHERE (ct.created BETWEEN fromDate AND toDate) AND (ct.retailer_id = retailerId) AND (ct.event_id = eventId) ")
        viewsql.append("            UNION ")
        viewsql.append("            SELECT cth.id, cth.created, cth.amount, cth.total_amount, cth.client_location, cth.client_transaction_id, cth.terminal_id, cth.disputed, cth.disputedby, cth.refunded, cth.refundedby, cth.customer_code, cth.redeemed, cth.retailer_user_id, cth.event_id, tm.serial_number ")
        viewsql.append("            FROM us.code_transaction_history_view_deleted_no AS cth ")
        viewsql.append("            JOIN us.terminal AS tm ON tm.id = cth.terminal_id ")
        viewsql.append("            WHERE (cth.created BETWEEN fromDate AND toDate) AND (cth.retailer_id = retailerId) AND (cth.event_id = eventId) ")
        viewsql.append("            ORDER BY created DESC; ")
        viewsql.append("    END IF; ")
        
        // THIS IS THE START OF THE REGULAR FUNCTION WITH OFFSET AND LIMIT:
        viewsql.append("    ELSIF (retailerUserId = 0) AND (terminalId = 0) AND (eventId = 0) THEN ")
    ...
    public func addTransactionReportTotalsFunction(_ schemaIn:String? = "public")-> String {
        ...
        var viewsql = "CREATE OR REPLACE FUNCTION \(schema).getTransactionReportTotals(fromDate bigint, toDate bigint, retailerId int, terminalId int=0, retailerUserId int=0, eventId int=0, OUT total_count bigint, OUT total_value numeric, OUT total_sales numeric, OUT total_refund_value numeric, OUT total_refund_sales numeric) "
        viewsql.append("AS ")
        viewsql.append("$$ ")
        ...
        viewsql.append("        total_refund_value := 0.0; ")
        viewsql.append("        total_refund_sales := 0.0; ")
        ...
        viewsql.append("            ELSE ")
        viewsql.append("                total_refund_value := total_refund_value + var_r.amount; ")
        viewsql.append("                total_refund_sales := total_refund_sales + var_r.total_amount; ")
        viewsql.append("            END IF;")
