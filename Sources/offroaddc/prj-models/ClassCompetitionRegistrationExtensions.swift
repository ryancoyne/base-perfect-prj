...
extension Dictionary where Key == String, Value == Any {
    var class_competition_registration : ClassCompetitionRegistrationDictionary {
        get {
            var bc = ClassCompetitionRegistrationDictionary()
            bc.dic = self
            return bc
        }
        set {
...
struct ClassCompetitionRegistrationDictionary {
    ...
    var class_competition_date_id : Int? {
        get {
            return self.dic["class_competition_date_id"] as? Int
        }
        set {
            if newValue != nil {
                self.dic["class_competition_date_id"] = newValue!
            } else {
                self.dic.removeValue(forKey: "class_competition_date_id")
            }
        }
    }
