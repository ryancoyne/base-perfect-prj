...
public class ClassType: PostgresStORM {
    ...
    //MARK: Table name
    override public func table() -> String { return "class_type" }
    ...
    override open func to(_ this: StORMRow) {
        ...
        if let data = this.data.class_type.name {
            name = data
        }
        
        if let data = this.data.class_type.description {
            description = data
        }
    ...
    func asDictionary() -> [String: Any] {
        ...
        if self.name.isNotNil {
            dictionary.class_type.name = self.name
        }
        
        if self.description.isNotNil {
            dictionary.class_type.description = self.description
        }
